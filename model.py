...
# Predict latitude and longitude for the new location along a specified area
...
# Predict latitude for the test set
y_pred_lat = rf_model_lat.predict(X_test_lat)

# Predict longitude for the test set
y_pred_long = rf_model_long.predict(X_test_long)

# Calculate MSE for latitude prediction
mse_lat = mean_squared_error(y_test_lat, y_pred_lat)
print("\nMean Squared Error (MSE) for Latitude Prediction:", mse_lat)

# Calculate MSE for longitude prediction
mse_long = mean_squared_error(y_test_long, y_pred_long)
print("Mean Squared Error (MSE) for Longitude Prediction:", mse_long)
